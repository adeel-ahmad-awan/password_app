...
class PasswordsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create password" do
    assert_difference('Password.count') do
      post passwords_url, params: { password: { email: @password.email, link: @password.link, name: @password.name, notes: @password.notes, password: @password.password, username: @password.username } }
    end
  ...
  test "should update password" do
    patch password_url(@password), params: { password: { email: @password.email, link: @password.link, name: @password.name, notes: @password.notes, password: @password.password, username: @password.username } }
